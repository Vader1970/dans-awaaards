    ...
    <section className='bg-black pb-52'>
      <div className='container mx-auto px-3 md:px-10'>
        <div className='px-5 py-32'>
          ...
          <p className='max-w-md font-circular-web text-lg text-blue-50 opacity-70'>
...
BentoCard.propTypes = {
  ...
  title: PropTypes.node, // title can be any renderable React node
  description: PropTypes.string, // descripton should be a string
};

BentoTilt.propTypes = {
  children: PropTypes.node.isRequired, // Correct prop name is 'children'
